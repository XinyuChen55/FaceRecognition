...
5. 然后我选择了四个属性，金发，性别，年龄和笑容，在测试集上分别进行编辑，得到对应的单张属性编辑后的图像，并对其与原图像进行了比较。改变金发属性的图像的FID: 24.65839926424721，Inception Score: 2.937446 ± 0.1068424，LPIPS Score: 0.1354。 改变性别属性的图像的FID:  18.228286859510547，Inception Score: 3.211716 ± 0.09631891，LPIPS Score: 0.0850。改变年龄属性的图像的FID:  17.04842722269143，Inception Score: 3.239423 ± 0.1096904，LPIPS Score: 0.0811，改变笑容属性的图像的FID:  13.939245935864733，Inception Score: 3.341577 ± 0.1467372，LPIPS Score: 0.0797。

    FID低越说明生成图像和真实图像分布越接近，从结果来看，模型已经能够完成基本的人脸属性编辑任务，生成结果算好的。IS则是越高说明图片越清晰，整体样本越多样。但从我的结果来看，IS是偏低的，我认为有一部分是因为生成图片都是人脸，类别差异不是很大，所以会导致分数偏低。LPIPS分数整体也比较低，说明生成图像在完成属性编辑的同时，和原图对比也保持了比较高的相似性。计算LPIPS的代码在[attrs_edit_eval.py](../docs/attrs_edit_eval.py)。