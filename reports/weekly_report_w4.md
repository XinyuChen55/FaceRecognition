...
5. 同时我完成了部分任务五，我首先通过ResNet和ArcFace学习了人脸识别模型的基本原理。ResNet是一个模型的backbone，主要用skip connection / residual block把上一层得特征直接传下去，并在这基础上学习一些小修正量，这样网络就可以做得更深还不降低训练的效果。ArcFace是训练时用到的一种损失函数，他通过加入angular margin让同一个人的特征向量靠得更近，不同的人分得更开，所以做人脸识别的时候会更准确。
